...
export const NOVEL_TYPE_DIMS: Record<string, string[]> = {
  ...
  '都市': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','socialRealism'],
  '修仙': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','cultivationCombat'],
  '武侠': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','cultivationCombat','archaicStyle'],
  '恋爱': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','romanceArc'],
  '古风': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','archaicStyle'],
  '悬疑': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','suspensePacing'],
  '历史': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','archaicStyle','socialRealism'],
  '穿越': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','socialRealism','cultivationCombat'],
  '科幻': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','socialRealism'],
  '玄幻': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','cultivationCombat','archaicStyle','compoundWordPattern','onomatopoeiaSystem'],
  '奇幻': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','socialRealism','cultivationCombat','compoundWordPattern'],
  '灵异': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','suspensePacing','onomatopoeiaSystem'],
  '游戏': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','moodStyle','dialogueStyle','perspectiveStyle','tensionStyle','descriptionPattern','suspensePacing'],
  '末世': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','socialRealism','suspensePacing','compoundWordPattern'],
  '轻小说': ['narrativeTone','sentenceStyle','vocabularyStyle','rhetoricStyle','rhythmStyle','dialogueStyle','moodStyle','perspectiveStyle','bodyLanguageStyle','sensoryStyle','tensionStyle','descriptionPattern','compoundWordPattern','onomatopoeiaSystem'],
...
export const DIMENSION_META: Record<string, { label: string; category: string; prompt: string }> = {
  ...
  onomatopoeiaSystem:{ label: '情色声音系统', category: '情色专属', prompt: `"onomatopoeiaSystem": {"description":"分析情色场景中所有声音——不只是叫床，而是整个场景的声音编码系统。必须分析: 1)动作→声音的映射表（接吻→滋滋/插入→噗嗤/撞击→啪啪/拔出→啵/高潮→尖叫/脚步→哒哒哒）2)每种声音的密度（单次/连续重复）和排版格式（是否单独成行/感叹号分隔）3)声音在段落中的触发位置（动作前/动作中/动作后）4)喉音与唇音的交替模式 5)叫床声与台词的融合方式（分开写/融合写）。引用原文中所有声音密集段落。","examples":["原文声音密集段落，标注每种声音的类型和格式"],"writingRules":["可操作的声音规则，如'每个插入场景必须包含噗嗤声，撞击场景用啪啪连续重复'"],"vocabularyList":["完整的声音词汇清单，按动作类型分组"]}"` },
