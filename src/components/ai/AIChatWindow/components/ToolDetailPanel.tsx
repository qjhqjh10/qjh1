...
import { DocumentTextIcon, MagnifyingGlassIcon, FolderOpenIcon, PencilSquareIcon, PlusIcon, TrashIcon, TagIcon, SparklesIcon, PhotoIcon, GlobeAltIcon, WrenchScrewdriverIcon, XMarkIcon, CheckCircleIcon, ClockIcon, FireIcon } from '@heroicons/react/24/outline'
