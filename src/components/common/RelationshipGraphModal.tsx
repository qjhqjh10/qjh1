...
export default function RelationshipGraphModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} width="90vw">
      <div style={{
        height: '85vh', maxWidth: 1100, display: 'flex', flexDirection: 'column', overflow: 'hidden',
      }}>
        {/* Header */}
        <div style={{
          display: 'flex', alignItems: 'center', justifyContent: 'space-between',
          padding: '0 0 12px 0', borderBottom: '1px solid rgba(0,0,0,0.06)',
        }}>
