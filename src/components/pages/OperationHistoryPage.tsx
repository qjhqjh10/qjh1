...
export default function OperationHistoryPage() {
  ...
  return (
    <div style={{ padding: '24px 32px', maxWidth: 900, margin: '0 auto' }}>
      ...
      {/* Entry list */}
      {filtered.length === 0 ? (
        <div style={{ textAlign: 'center', color: '#9b8e84', fontSize: 13, padding: 48 }}>
            ...
            return (
              <GlassCard key={entry.id} style={{ padding: '12px 16px' }}>
                ...
                >
                  ...
                  <span style={{ fontSize: 11, color: '#6b5e54', maxWidth: 200, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                    {entry.filePath}
                  </span>
      ...
      {/* Footer info */}
      <div style={{ marginTop: 24, textAlign: 'center', fontSize: 11, color: '#9b8e84' }}>
