...
import {
  LOCATIONS as EROTIC_LOCATIONS, TIMES as EROTIC_TIMES, ATMOSPHERES, POVS,
...
import {
  ...
  SENSORY_ANCHORS, NOVEL_NARRATIVE_STYLES, NOVEL_TIME_COMPRESSION, NOVEL_INTROSPECTION,
...
import { AutoField, CustomInput } from "./helpers";
