...
const TASK_KEYWORDS = /创建|新建|修改|编辑|删除|生成|写入|添加|追加|读取|查看|列出|搜索|笔记|草稿|知识库|素材|图片|模板|风格|场景|提示词|prompt|项目|project|规则|学习|写一|改一|帮我写|帮我改|帮我创建|帮我编辑|大纲|细纲|章节|角色|人物|剧情|世界观|续写|仿写|分析|总结|替换|重命名|移动|复制|导出|备份|检查|诊断|修复|优化|整理|梳理|扩充|精简|润色|重写|规划|导入|第\d+章|第[一二三四五六七八九十百千]+章|写.{0,3}章|改.{0,3}章|生成.{0,3}章|创作.{0,3}章/u
