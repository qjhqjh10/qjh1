...
export const TYPE_LABELS: Record<string, string> = {
  ...
  transmigration: '穿越', scifi: '科幻', erotic: '涩涩',
}
...
export const DIM_LABELS: Record<string, string> = {
  ...
  powerSystem: '等级', foreshadowing: '伏笔', emotionCurve: '情绪', erotic: '涩涩',
...
export const NOVEL_TYPE_CARDS: { type: NovelType; label: string; icon: typeof BookOpenIcon; color: string; desc: string }[] = [
  ...
  { type: 'erotic', label: '涩涩', icon: FireIcon, color: '#dc2626', desc: 'dom-sub·身体状态·性爱流程·体液·权力' },
]
